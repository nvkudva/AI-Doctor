...
const ICON_PATHS: Record<string, React.ReactNode> = {
  ...
  camera: <><path d="M3 8.6h3.4l1.6-2.4h8l1.6 2.4H21V19H3z" /><circle cx="12" cy="13.6" r="3.6" /></>,
  pill: <><rect x="2.7" y="8.5" width="18.6" height="7" rx="3.5" transform="rotate(-45 12 12)" /><path d="M8.8 8.8l6.4 6.4" /></>,
  flask: <><path d="M9.2 3h5.6" /><path d="M10.2 3v6.4L5 17.9A2 2 0 0 0 6.7 21h10.6a2 2 0 0 0 1.7-3.1L13.8 9.4V3" /><path d="M7.6 14.6h8.8" /></>,
  notepad: <><rect x="4.2" y="3.4" width="15.6" height="17.2" rx="2.4" /><path d="M8.4 8.2h7.2M8.4 12h7.2M8.4 15.8h4.4" /></>,
  stethoscope: <><path d="M6 3v5a4 4 0 0 0 8 0V3" /><path d="M10 15.5V13" /><path d="M10 15.5a4.5 4.5 0 0 0 9 0v-2" /><circle cx="19" cy="10.6" r="2.4" /></>,
  alert: <><path d="M12 8.6v4.6" /><path d="M12 16.9h.01" /><path d="M10.6 3.9 2.4 18a1.6 1.6 0 0 0 1.4 2.4h16.4a1.6 1.6 0 0 0 1.4-2.4L13.4 3.9a1.6 1.6 0 0 0-2.8 0z" /></>,
  ban: <><circle cx="12" cy="12" r="8.6" /><path d="M6 6l12 12" /></>,
  cal: <><rect x="3.4" y="5.2" width="17.2" height="15.4" rx="2.4" /><path d="M16 3v4M8 3v4M3.4 10.6h17.2" /></>,
  video: <><path d="M22 8.2 16.6 12 22 15.8z" /><rect x="2" y="6" width="14.6" height="12" rx="2.4" /></>,
